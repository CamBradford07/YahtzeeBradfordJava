...
private boolean checkFullHouse(){
  ...
  if(oneCount == 3){
    if(twoCount == 2){hasFullHouse = true;}
    else if(threeCount == 2){hasFullHouse = true;}
    else if(fourCount == 2){hasFullHouse = true;}
    else if(fiveCount == 2){hasFullHouse = true;}
    else if(sixCount == 2){hasFullHouse = true;}
  }
  else if(twoCount == 3){
    if(oneCount == 2){hasFullHouse = true;}
    else if(threeCount == 2){hasFullHouse = true;}
    else if(fourCount == 2){hasFullHouse = true;}
    else if(fiveCount == 2){hasFullHouse = true;}
    else if(sixCount == 2){hasFullHouse = true;}
    ...
    if(twoCount == 2){hasFullHouse = true;}
    else if(oneCount == 2){hasFullHouse = true;}
    else if(fourCount == 2){hasFullHouse = true;}
    else if(fiveCount == 2){hasFullHouse = true;}
    else if(sixCount == 2){hasFullHouse = true;}
  }
...
boolean[] upperDone = {onesDone, twosDone, threesDone, foursDone, fivesDone, sixesDone};
